            ...
            <div>
                <div className="container" style={{ backgroundColor: 'white' }}>
                    ...
                    {this.props.section === "sale" ? <h5 className='text-left' id='title'><i style={{color: 'rgb(241, 159, 77)'}} className="fa fa-shopping-cart" aria-hidden="true"></i> {singleItem.title}</h5> : ""}
                        ...
                        {this.props.section === 'service' ? <h5>service</h5> : ""}
                            {this.props.section === 'rent' ? <h5>rent</h5> : ""}
                            {this.props.section === 'sale' ? <h5>sale</h5> : ""}
                        </div>
                    </div>
                    <div className="row">
                        ...
                        <div className="col-sm-4" >
                            <strong><h4 style={{ color: '#390' }} className="googleFont"><span style={{ color: '#0093d3' }} className="glyphicon glyphicon-check"></span> description:</h4></strong><hr />
                        ...
                        <div className="col-sm-4" >
                            ...
                            <h4 className='text-left'><i className="fa fa-mobile" aria-hidden="true"></i>
                                <strong> Phone:</strong> {" "}{singleItem ? singleItem.phone_number : ""}</h4>
                                <h4 className='text-left'><i className="fa fa-money" aria-hidden="true"></i><strong> Price:</strong> {singleItem ? singleItem.price : ""} <span style={{ color: '#0093d3' }}>USD</span></h4>
                                {singleItem && singleItem.condition ?
                                <h4 className='text-left'>
                                <i className="fa fa-heartbeat" aria-hidden="true"></i>&nbsp;
                                <strong>Condition:{" "}</strong>{singleItem.condition}</h4> : ""}
                            <h4 className='text-left'><i className="fa fa-eye" aria-hidden="true"></i>
                                <strong> Views:</strong> {" "}{singleItem ? singleItem.views : ""}</h4>
                        </div>
                    </div>
                    <div className='row'>
