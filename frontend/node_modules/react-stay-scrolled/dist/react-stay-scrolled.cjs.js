...
var ScrolledContext = React.createContext({});
...
function (_Component) {
  ...
  function StayScrolled() {
    ...
    _defineProperty(_assertThisInitialized(_assertThisInitialized(_this)), "dom", React.createRef());
  ...
  _createClass(StayScrolled, [{
    ...
    value: function render() {
      ...
      return React__default.createElement(ScrolledContext.Provider, {
        value: context
...
var scrolled_hoc = (function (WrappedComponent) {
  function forwardScrolled(props, ref) {
    return React__default.createElement(ScrolledContext.Consumer, null, function (_ref) {
  ...
  return hoistStatics(React.forwardRef(forwardScrolled), WrappedComponent);
});

exports.default = StayScrolled;
exports.scrolled = scrolled_hoc;
